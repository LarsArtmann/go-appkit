...
require (
	...
	github.com/larsartmann/go-cqrs-lite/stack/sqlite/v4 none
	github.com/larsartmann/go-cqrs-lite/stack/v4 none
...
require (
	...
	github.com/larsartmann/go-cqrs-lite/middleware/v4 v4.5.1 // indirect
