...
func TestOpenSQLite_EmptyPath(t *testing.T) {
	...
	expectOpenSQLiteError(t, "", "expected error for empty path")
}
...
func TestOpenSQLite_DisallowedPRAGMA(t *testing.T) {
	...
	expectError(t, err, "expected error for disallowed PRAGMA key")
}
...
func TestOpenSQLite_OpenError(t *testing.T) {
	...
	expectOpenSQLiteError(t, "/nonexistent/dir/test.db", "expected error for nonexistent path")
}
