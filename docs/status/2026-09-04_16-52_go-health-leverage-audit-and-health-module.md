...
~~| b2 | flightrecorderhealth release prep           | CHANGELOG [Unreleased] written, tests/lint green, contract asserted against v0.1.1                                   | Pre-tag hermetic fresh-consumer check, the actual `flightrecorderhealth/v0.1.1` tag (gated on push)                                                         |~~ done — flightrecorderhealth/v0.1.1 tagged + pushed 2026-09-04
~~| b3 | health module release prep                  | Module complete, example replace noted, TODO_LIST item written                                                       | Drop `replace ../`, require published core, hermetic verify, tag `health/v0.1.0` (gated on push + core tag)                                                 |~~ done — health/v0.1.0 tagged + pushed 2026-09-04
...
~~| b6 | Docs-health wiring                          | This report + TODO_LIST item                                                                                         | Numbered-item annotation pass and the §g answers back into TODO_LIST after user decisions                                                                   |~~ done — 2026-09-16 docs-health audit annotated + archived the trail
