...
_This plan commits only this file. Shared-doc edits (TODO_LIST, FEATURES, AGENTS) are explicit tasks inside the waves, never silent side effects. Next planning cycle: after the Wave A/B gates are answered or W3 ships, whichever comes first._
