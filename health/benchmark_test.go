...
func BenchmarkNewProbe_Batch_N1(b *testing.B)  { probeBatchBench(b, 1) }
func BenchmarkNewProbe_Batch_N5(b *testing.B)  { probeBatchBench(b, 5) }
func BenchmarkNewProbe_Batch_N20(b *testing.B) { probeBatchBench(b, 20) }
